...
def pro_one_file(filepath):
    # 去除头部注释
    print(filepath)
    if filepath=='/home/fzc/dataset/msr/0-src/novul_nocwe/0_CVE-2016-2391_qemu_fa1298c2d623522eda7b4f1f721fcb935abb7360.c':
        print(filepath)
    linefeed='\n'
    ...
    temp_file='/home/fzc/dataset/mytest/temp'
    ...
    # norm_path="/home/fzc/dataset/mytest/0day_normal"  # 没漏洞
    norm_path="/home/fzc/dataset/mytest/1day_normal"  # 有漏洞
...
if __name__ == '__main__':
    ...
    # normalize("/home/fzc/dataset/mytest/0day")
    # normalize("/home/fzc/dataset/msr/0-src/novul_nocwe")
    normalize("/home/fzc/dataset/msr/0-src/vul_nocwe/")
