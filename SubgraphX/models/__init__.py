...
from models.RGCN import RGCNNet, RGCNNet_NC
...
def get_model(input_dim, output_dim, model_args):
    ...
    elif model_args.model_name.lower() == 'rgcn':
        return RGCNNet(input_dim, output_dim, model_args)
    else:
        raise NotImplementedError


def get_model_NC(input_dim, output_dim, model_args):
    print('model_args.model_name:',model_args.model_name)
    if model_args.model_name.lower() == 'gcn':
        ...
        return RGCNNet_NC(input_dim, output_dim, model_args)
    else:
        raise NotImplementedError
