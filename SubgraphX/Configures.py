...
class DataParser(Tap):
    ...
    dataset_dir: str = '/home/fzc/workspace/VulnerabilityDetectionResearch/SubgraphX/datasets'
...
class MCTSParser(DataParser, ModelParser):
    ...
    # explain_model_path:'/home/fzc/workspace/VulnerabilityDetectionResearch/SubgraphX/checkpoints/ba_shapes/GCN_2l/GCN_2l_best.ckpt'
    # explain_model_path:'SubgraphX'
    def process_args(self) -> None:
        ...
        self.test_ckpt = '/home/fzc/workspace/vdgraph/vul_detect/model/mod_mix60.58_86.07_71.78.ckpt'
