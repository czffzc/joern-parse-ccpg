...
def parse_options():
    ...
    # /home/fzc/dataset/mytest/0day_normal/
    # parser.add_argument('-i', '--input', help='A txt file including all path of targeted src files', type=str,default='/home/fzc/dataset/all_data_preprocess/3-src_norm/our_data/vul1/')
    ...
    # parser.add_argument('-i', '--input', help='A txt file including all path of targeted src files', type=str,default='/home/fzc/dataset/msr/0-src/novul_nocwe/')
    parser.add_argument('-i', '--input', help='A txt file including all path of targeted src files', type=str,default='/home/fzc/dataset/msr/0-src/vul_nocwe/')
    # parser.add_argument('-o', '--output', help='The dir path of output', type=str,default='/home/fzc/dataset/all_data_preprocess/4-parse_res/our_data/novul')
    parser.add_argument('-o', '--output', help='The dir path of output', type=str,default='/home/fzc/dataset/all_data_preprocess/4-parse_res/our_data/vul')
...
def joern_parse(file, outdir):
    ...
    out = outdir + name + '.bin'
    print('out:',out)
    # print('/home/fzc/software/joern-1.1.172/joern-cli/joern-parse $file --out $out')
    ...
    # os.system('joern-parse $file --language c --output $out')
    # os.system('joern-parse $file --language c --output $out')
    
    os.system('/home/fzc/software/joern-1.1.172/joern-cli/joern-parse $file --out $out')
