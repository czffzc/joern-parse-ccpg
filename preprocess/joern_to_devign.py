...
def main():
    ...
    parser.add_argument('--input_dir', type=str, help='Input Directory of the parser',default='/home/fzc/dataset/all_data_preprocess/6-pdg/our_data/6-our-novul/')
    parser.add_argument('--output_dir', type=str, help='Output Directory of the parser',default='/home/fzc/dataset/all_data_preprocess/final/')
    ...
    word_vectors = KeyedVectors.load('/home/fzc/dataset/msr/w2v_model/w2v_pdg_bigvul_nofilter.wv', mmap='r')
    pool = Pool(4)
