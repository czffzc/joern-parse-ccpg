#!/bin/sh
python -m forgraph.subgraphx --dataset_name devign --random_split True --reward_method mc_l_shapley \
        --dataset_dir /home/fzc/dataset/all_data_preprocess/final/dataset/
# python -m forgraph.subgraphx --dataset_name mutag --random_split True --reward_method mc_l_shapley \
#         --dataset_dir /home/fzc/dataset/all_data_preprocess/final/dataset/
