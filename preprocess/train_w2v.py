...
def process_parallel(path: str, split_token: bool):
    ...
    try:
        ...
        # pdg = nx.drawing.nx_agraph.read_dot(path)
        # print('pdg:',pdg)
...
def train_word_embedding(config_path: str):
    ...
    # train_path = "/home/fzc/dataset/msr/0-src/vul_nocwe"
    
    # train_path2 ="/home/fzc/dataset/msr/0-src/vul_nocwe/"
    ...
    model.wv.save("/home/fzc/dataset/msr/w2v_model/w2v_pdg_bigvul_nofilter.wv")
