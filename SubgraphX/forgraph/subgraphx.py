...
sys.path.append('..')
sys.path.append('../..')
# sys.path.append('/home/fzc/workspace/vdgraph/vul_explainer/SubgraphX')
sys.path.append('/home/fzc/workspace/vdgraph/vul_explainer/SubgraphX/forgraph')
print(sys.path)
...
def pipeline(max_nodes):
    print('data_args.dataset_dir',data_args.dataset_dir)
    ...
    for i in tqdm(data_indices):
        ...
        result_path = '/home/fzc/workspace/vdgraph/vul_explainer/SubgraphX/save_results/'+data['name'].split('/')[-1]
        ...
        with open('/home/fzc/workspace/vdgraph/vul_explainer/SubgraphX/save_results/'+data['name'].split('/')[-1],'w') as wp:
