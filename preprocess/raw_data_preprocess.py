...
def main():
    ...
    dataset_path ='/home/fzc/dataset/MSR/'
    ...
    # out_path_before = '/home/Dataset/msr/0-src/vul_nocwe'
    # out_path_after = '/home/Dataset/msr/0-src/novul_nocwe'
    out_path_before = '/home/fzc/dataset/msr/0-src/vul_nocwe'
    out_path_after = '/home/fzc/dataset/msr/0-src/novul_nocwe'
    #pkl_path = dataset_path + label_pkl_file
    # json_path = '/home/nvd_label.json'
    json_path = '/home/fzc/nvd_label.json'
    pd_filter = process_raw_data(filter_csv_path, raw_csv_path)
    file_cnt = pd_filter.shape[0]
    file_num = 0
    label_dict = {}
    cnt_1 = 0
    for index, row in tqdm(pd_filter.iterrows(), total=pd_filter.shape[0]):
